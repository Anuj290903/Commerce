# Generated by Django 4.2.4 on 2024-03-04 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='auctions/media/')),
                ('active', models.BooleanField(default=True)),
                ('fin_price', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
